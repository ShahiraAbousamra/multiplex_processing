...
<head>
<?php $y = $_COOKIE["y"];?>
<title>Multiplex-labeling</title>
<style>
.page_container {
    width: 100%;
    margin: auto;
...
<a href=view_patches_multiplex.php?page=<?PHP printf("%d", $page - 10);?>>Prev Page-10</a>
<a href=view_patches_multiplex.php?page=<?PHP printf("%d", $page - 1);?>>Prev Page</a>
<a href=view_patches_multiplex.php?page=<?PHP printf("%d", $page + 1);?>>Next Page</a>
<a href=view_patches_multiplex.php?page=<?PHP printf("%d", $page + 10);?>>Next Page+10</a>
<p>
<?PHP 
$N_per_page = 8;
$folder = 'images';
...
printf("CD3<br/>");
printf("<input type=\"submit\" name=\"cd3l\" value=\"%s\"> Low <br>\n", strpos($class0,'cd3l')!==false ? 'x':'  ');
printf("<input type=\"submit\" name=\"cd3h\" value=\"%s\"> High <br>\n", strpos($class0,'cd3h')!==false ? 'x':'  ');
printf("</div>");

printf("<br>\n");
printf("<div class=\"label_cd4\">");
printf("CD4<br/>");
printf("<input type=\"submit\" name=\"cd4l\" value=\"%s\"> Low <br>\n", strpos($class0,'cd4l')!==false ? 'x':'  ');
printf("<input type=\"submit\" name=\"cd4h\" value=\"%s\"> High <br>\n", strpos($class0,'cd4h')!==false ? 'x':'  ');
printf("</div>");

printf("<br>\n");
printf("<div class=\"label_cd20\">");
printf("CD20<br/>");
printf("<input type=\"submit\" name=\"cd20l\" value=\"%s\"> Low <br>\n", strpos($class0,'cd20l')!==false ? 'x':'  ');
printf("<input type=\"submit\" name=\"cd20h\" value=\"%s\"> High <br>\n", strpos($class0,'cd20h')!==false ? 'x':'  ');
printf("</div>");
...
printf("CD8<br/>");
printf("<input type=\"submit\" name=\"cd8l\" value=\"%s\"> Low <br>\n", strpos($class0,'cd8l')!==false ? 'x':'  ');
printf("<input type=\"submit\" name=\"cd8h\" value=\"%s\"> High <br>\n", strpos($class0,'cd8h')!==false ? 'x':'  ');
printf("</div>");

printf("<br>\n");
printf("<div class=\"label_cd16\">");
printf("CD16<br/>");
printf("<input type=\"submit\" name=\"cd16l\" value=\"%s\"> Low <br>\n", strpos($class0,'cd16l')!==false ? 'x':'  ');
printf("<input type=\"submit\" name=\"cd16h\" value=\"%s\"> High <br>\n", strpos($class0,'cd16h')!==false ? 'x':'  ');
printf("</div>");
...
printf("<a href=view_patches_multiplex.php?page=%d>Prev Page</a>\n", $page-1);
printf("<a href=view_patches_multiplex.php?page=%d>Next Page</a>\n", $page+1);
printf("</section>\n");
printf("</section>\n");
?>
